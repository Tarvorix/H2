...
export {
  ...
  BLACKSHIELDS_OATHS,
  BLACKSHIELDS_SUPPLEMENT_UNIT_IDS,
  BLACKSHIELDS_TAINT_OF_THE_XENOS_OPTIONS,
  BLACKSHIELDS_WEAPONS_OF_DESPERATION_OPTIONS,
...
export {
  ...
  SHATTERED_LEGIONS_COMMANDER_UNIT_IDS,
